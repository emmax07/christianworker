...
import IrelandData from "./Churches.json";
...
function Ireland() {
  ...
  useEffect(() => {
    ...
    const filteredByRegion = IrelandData.filter(
      (church) => church.region === "Ireland"
    ).sort((a, b) => a.church_name.localeCompare(b.church_name));

    setChurches(IrelandData); // Keep full dataset for search
    setFilteredPlaces(filteredByRegion); // Only Ireland, sorted A-Z
  }, []);
  ...
  return (
    <div className="main-container">
      ...
      <div className="directory-container">
        <h1>Ireland Church Directory</h1>
