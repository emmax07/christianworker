...
import ScotlandData from "./Churches.json";
...
function Scotland() {
  ...
  useEffect(() => {
    ...
    const filteredByRegion = ScotlandData.filter(
      (church) => church.region === "Scotland"
    ).sort((a, b) => a.church_name.localeCompare(b.church_name));

    setChurches(ScotlandData); // Keep full dataset for search
    setFilteredPlaces(filteredByRegion); // Only Scotland, sorted A-Z
  }, []);
  ...
  return (
    <div className="main-container">
      ...
      <div className="directory-container">
        <h1>Scotland Church Directory</h1>
