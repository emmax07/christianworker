...
import englandData from "./Churches.json";
...
function England() {
  ...
  useEffect(() => {
    ...
    const filteredByRegion = englandData
      .filter((church) => church.region === "England")
      .sort((a, b) => a.church_name.localeCompare(b.church_name));

    setChurches(englandData); // Keep full dataset for search
    setFilteredPlaces(filteredByRegion); // Only England, sorted A-Z
  }, []);
  ...
  return (
    <div className="main-container">
      ...
      <div className="directory-container">
        <h1>England Church Directory</h1>
