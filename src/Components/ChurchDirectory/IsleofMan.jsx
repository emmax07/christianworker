...
import IsleofManData from "./Churches.json";
...
function IsleofMan() {
  ...
  useEffect(() => {
    ...
    const filteredByRegion = IsleofManData.filter(
      (church) => church.region === "Isle of Man"
    ).sort((a, b) => a.church_name.localeCompare(b.church_name));

    setChurches(IsleofManData); // Keep full dataset for search
    setFilteredPlaces(filteredByRegion); // Only IsleofMan, sorted A-Z
  }, []);
  ...
  return (
    <div className="main-container">
      ...
      <div className="directory-container">
        <h1>IsleofMan Church Directory</h1>
