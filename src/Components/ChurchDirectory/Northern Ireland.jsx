...
import NorthernIrelandData from "./Churches.json";
...
function NorthernIreland() {
  ...
  useEffect(() => {
    ...
    const filteredByRegion = NorthernIrelandData.filter(
      (church) => church.region === "Northern Ireland"
    ).sort((a, b) => a.church_name.localeCompare(b.church_name));

    setChurches(NorthernIrelandData); // Keep full dataset for search
    setFilteredPlaces(filteredByRegion); // Only NorthernIreland, sorted A-Z
  }, []);
      ...
      const filtered = churches
        .filter(
          (church) =>
            ...
            church.region === "Northern Ireland"
        )
        .sort((a, b) => a.church_name.localeCompare(b.church_name));
  ...
  return (
    <div className="main-container">
      ...
      <div className="directory-container">
        <h1>NorthernIreland Church Directory</h1>
